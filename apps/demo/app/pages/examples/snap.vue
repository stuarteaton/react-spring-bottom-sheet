...
<template>
  <div class="content py-8 max-w-xl px-5 mx-auto">
    ...
    <h1 class="text-2xl mb-6 font-semibold">Snap point & content drag</h1>
  ...
  <ClientOnly>
    ...
    >
      <div class="button-group">
        <UButton type="button" class="flex-1" @click="snapToPoint(0)">Top</UButton>
        <UButton type="button" class="flex-1" @click="snapToPoint(1)">Middle</UButton>
        <UButton type="button" class="flex-1" @click="snapToPoint(2)">Bottom</UButton>
        <UButton type="button" class="flex-1" @click="snapToPoint(3)">Instinct</UButton>
      </div>
      <UButton
        type="button"
