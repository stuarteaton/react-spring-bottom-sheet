...
<template>
  <div>
    <div class="content py-8 max-w-xl px-5 mx-auto">
      ...
      <h1 class="text-2xl mb-6 font-semibold">Basic</h1>
    ...
    <ClientOnly>
      <BottomSheet ref="bottomSheet">
        <p class="mb-4">
          ...
          impedit iure facilis ipsam sit cum molestias, natus, cupiditate molestiae, id
          exercitationem eaque obcaecati a animi. Accusamus, pariatur.
        </p>
        <details class="mb-4">
        ...
        <div>
          <UButton type="button" class="mb-4" @click="close"> Close bottom sheet </UButton>
        </div>
      </BottomSheet>
    </ClientOnly>
  </div>
