...
<template>
  ...
  <BottomSheet ref="bottomSheet">
    <p class="mb-4">
      Lorem ipsum dolor sit amet consectetur adipisicing elit. Alias atque error dignissimos impedit
      iure facilis ipsam sit cum molestias, natus, cupiditate molestiae, id exercitationem eaque
      obcaecati a animi. Accusamus, pariatur.
    </p>
    <details class="mb-4">
